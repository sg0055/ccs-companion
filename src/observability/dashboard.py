...
# Fallback path adjustment to ensure imports work when run directly via Streamlit CLI
...
# This hook ensures that running `streamlit run dashboard.py` triggers the UI
